...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Plot 1: Average automobile sales over recession period (year-wise) - Line chart
        ...
        # Plot 2: Average vehicles sold by vehicle type during recession - Bar chart
        ...
        # Plot 3: Total expenditure share by vehicle type during recession - Pie chart
    ...
    # TASK 2.6: Yearly Statistics Charts
        ...
        # Plot 1: Yearly automobile sales for whole period - Line chart
        yas = data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        Y_chart1 = dcc.Graph(
            figure=px.line(yas,
                x='Year',
                y='Automobile_Sales',
                title='Yearly Automobile Sales Statistics for the Whole Period'))

        # Plot 2: Total monthly automobile sales for selected year - Line chart
